...
public interface IModelElementTraceHasProperties {
     ...
     * @param target The IPropertyTrace to create a relation with
     * @throws TraceModelConflictRelation if a relation to another IPropertyTrace exists
     */
    boolean create(IPropertyTrace target) throws TraceModelConflictRelation;
