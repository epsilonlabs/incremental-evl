...
public class ModelElementVariable implements IModelElementVariable {
    ...
    public ModelElementVariable(String name, IModelElementTrace value, IExecutionContext container) throws TraceModelDuplicateRelation {
        this.name = name;
        // From Equals org.eclipse.emf.ecore.impl.EReferenceImpl@23109177 (name: value) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (containment: false, resolveProxies: true)
