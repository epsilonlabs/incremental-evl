...
public interface IAccessHasModule {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(IModuleExecutionTrace)}).
     * If the reference has an opposite, that relation is also created.
     *
     * @see ExecutionHasAccesses#conflict(IModuleExecutionTrace)
     * @see ExecutionHasAccesses#related(IModuleExecutionTrace)
     * @param target The IModuleExecutionTrace to create a relation with
     * @throws TraceModelConflictRelation if a relation to another IModuleExecutionTrace exists
     */
    boolean create(IModuleExecutionTrace target) throws TraceModelConflictRelation;
     ...
     * @see ExecutionHasAccesses#related(IModuleExecutionTrace)
     */    
    boolean destroy(IModuleExecutionTrace target);
     ...
     *  </li>
     */
    boolean conflict(IModuleExecutionTrace target);
    
    /**
     * Returns true if the target is already related via this reference.
     */
    boolean related(IModuleExecutionTrace target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(IModuleExecutionTrace)
     */
    void set(IModuleExecutionTrace target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(IModuleExecutionTrace)
     */
    void remove(IModuleExecutionTrace target);
}