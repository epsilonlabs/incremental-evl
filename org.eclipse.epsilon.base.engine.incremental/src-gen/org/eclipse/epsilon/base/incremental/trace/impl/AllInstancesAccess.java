...
public class AllInstancesAccess implements IAllInstancesAccess {
    ...
    public AllInstancesAccess(boolean ofKind, IModuleElementTrace executionTrace, IModelTypeTrace type) throws TraceModelDuplicateRelation {
        this.ofKind = ofKind;
        // From Equals org.eclipse.emf.ecore.impl.EReferenceImpl@6019b647 (name: type) (ordered: true, unique: true, lowerBound: 1, upperBound: 1) (changeable: true, volatile: false, transient: false, defaultValueLiteral: null, unsettable: false, derived: false) (containment: false, resolveProxies: true)
