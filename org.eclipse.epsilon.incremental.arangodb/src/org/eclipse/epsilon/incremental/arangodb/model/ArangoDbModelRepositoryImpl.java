package org.eclipse.epsilon.incremental.arangodb.model;
...
public class ArangoDbModelRepositoryImpl implements Repository<Model> {
	...
	public void add(Model item) {
		// TODO Implement Repository<Model>.add
		throw new UnsupportedOperationException("Unimplemented Method    Repository<Model>.add invoked.");
	}

	@Override
	public void add(Iterable<Model> items) {
		// TODO Implement Repository<Model>.add
		throw new UnsupportedOperationException("Unimplemented Method    Repository<Model>.add invoked.");
	}
	...
	public void update(Model item) {
		// TODO Implement Repository<Model>.update
		throw new UnsupportedOperationException("Unimplemented Method    Repository<Model>.update invoked.");
	}
