...
import org.eclipse.epsilon.evl.incremental.trace.tinkerpop.AbstractGuardImpl;
import com.tinkerpop.blueprints.impls.orient.OrientVertex;
import com.tinkerpop.gremlin.java.GremlinPipeline;

/**
 * An implementation of the Guard that delegates to an OrientDB vertex.
 */
public class GuardOrientDbImpl extends AbstractGuardImpl<OrientVertex> {
    
    /** The class name for Vertices of this type in the DB schema */
    public static final String VERTEX_TYPE = "Guard";
	...
	/**
     * Instantiates a new Guard OrientDb Impl.
     *
     * @param delegate the delegate
     */
    public GuardOrientDbImpl(OrientVertex  delegate) {
        super(delegate);
        if (!(delegate.getLabel() == "Guard")) {
            throw new IllegalArgumentException(
                    String.format("Delegate vertex is not of the correct type. Got: %s, expected: %s",
                        delegate.getLabel(), "Guard"));
        }
        delegate.detach();
        initTraces();
        initOwner();
    ...
    public void setId(Object value) {
        // TODO Implement GuardOrientDbImpl.setId
        throw new UnsupportedOperationException("Readonly field    GuardOrientDbImpl.setId invoked.");
    }
    ...
    public void setUri(String value) {
        delegate.getProperties().put("Guard", value);
    }    
