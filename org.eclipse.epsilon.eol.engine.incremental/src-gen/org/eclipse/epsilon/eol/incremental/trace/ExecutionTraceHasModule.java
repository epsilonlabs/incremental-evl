...
public interface ExecutionTraceHasModule {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(Module)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(Module)
     * @see ExecutionHasAccesses#related(Module)
     */
    boolean create(Module target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(Module)
     */
    void set(Module target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(Module)
     */
    void remove(Module target);
}