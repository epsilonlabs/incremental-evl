...
public interface ExecutionHasAccesses {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(Access)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(Access)
     * @see ExecutionHasAccesses#related(Access)
     */
    boolean create(Access target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(Access)
     */
    void set(Access target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(Access)
     */
    void remove(Access target);
}