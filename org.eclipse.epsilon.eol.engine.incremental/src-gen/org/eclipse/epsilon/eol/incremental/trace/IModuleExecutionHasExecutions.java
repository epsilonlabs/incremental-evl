...
public interface IModuleExecutionHasExecutions {
     ...
     */
    Queue<IExecutionTrace> get();

    /**
     * Create a reference to the target element. Returns true if the relation was created or if the
     * relation already existed. 
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(IExecutionTrace)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(IExecutionTrace)
     * @see ExecutionHasAccesses#related(IExecutionTrace)
     */
    boolean create(IExecutionTrace target);
     ...
     * @see ExecutionHasAccesses#related(IExecutionTrace)
     */    
    boolean destroy(IExecutionTrace target);
     ...
     *  </li>
     */
    boolean conflict(IExecutionTrace target);
    
    /**
     * Returns true if the target is already related via this reference.
     */
    boolean related(IExecutionTrace target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(IExecutionTrace)
     */
    void set(IExecutionTrace target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(IExecutionTrace)
     */
    void remove(IExecutionTrace target);
}