...
public interface PropertyAccessHasProperty {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(Property)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(Property)
     * @see ExecutionHasAccesses#related(Property)
     */
    boolean create(Property target);
     ...
     * @see ExecutionHasAccesses#related(Property)
     */    
    boolean destroy(Property target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(Property)
     */
    void set(Property target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(Property)
     */
    void remove(Property target);
}