...
public interface ModelTypeHasAccessedBy {
    
    /**
     * Get the value(s) for the reference
     */
    Queue<AllInstancesAccess> get();
     ...
     * and is already set.
     */
    boolean conflict(AllInstancesAccess target);
    
    /**
     * Retruns true if the target is already related via this reference.
     */
    boolean related(AllInstancesAccess target);
     ...
     * is also created.
     */
    boolean create(AllInstancesAccess target);
     ...
     * is also destroyed.
     */    
    boolean destroy(AllInstancesAccess target);
