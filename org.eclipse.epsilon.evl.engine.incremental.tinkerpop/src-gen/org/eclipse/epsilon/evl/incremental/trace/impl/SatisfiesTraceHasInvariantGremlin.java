...
public class SatisfiesTraceHasInvariantGremlin extends Feature
     ...
     */
    public SatisfiesTraceHasInvariantGremlin (ISatisfiesTrace source) {
        super(true);
        this.source = source;
    }
    ...
    public boolean related(IInvariantTrace target) {
		...
		return g.E(delegate).outV().id().next().equals(target.getId()) && source.equals(target.satisfies().get());
	}
