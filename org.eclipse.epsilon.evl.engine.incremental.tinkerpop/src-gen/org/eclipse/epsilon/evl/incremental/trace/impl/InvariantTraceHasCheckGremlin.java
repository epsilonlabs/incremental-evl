...
public class InvariantTraceHasCheckGremlin extends Feature
     ...
     */
    public InvariantTraceHasCheckGremlin (IInvariantTrace source, GraphTraversalSource gts) {
        super(true);
        this.source = source;
        this.gts = gts;
    }
    ...
    public ICheckTrace get() {
        ...
        try {
            ...
            result = (ICheckTrace) EvlTraceFactory.getFactory().createModuleElementTrace(to, gts);
        }
        finally {
            finishTraversal(g);
        }
