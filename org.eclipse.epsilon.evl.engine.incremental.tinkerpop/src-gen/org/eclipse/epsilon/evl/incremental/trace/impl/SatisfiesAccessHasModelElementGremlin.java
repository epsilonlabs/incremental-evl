 ...
 */
public class SatisfiesAccessHasModelElementGremlin extends Feature
        implements ISatisfiesAccessHasModelElement, GremlinWrapper<Edge> {
     ...
     */
    public SatisfiesAccessHasModelElementGremlin (
    ...
    public boolean conflict(IModelElementTrace target) {
        ...
        GraphTraversalSource g = startTraversal();
        try {
            result |= delegate == null ? g.V(source.getId()).out("modelElement").hasNext() : g.E(delegate).inV().hasId(target.getId()).hasNext();
        }
        finally {
            finishTraversal(g);
        }
    ...
    public void set(IModelElementTrace target) {
        GraphTraversalSource g = startTraversal();
        try {
            delegate = g.V(source.getId()).addE("modelElement").to(g.V(target.getId())).next();
        } catch (Exception ex) {
            throw ex;
        } finally {
            finishTraversal(g);
