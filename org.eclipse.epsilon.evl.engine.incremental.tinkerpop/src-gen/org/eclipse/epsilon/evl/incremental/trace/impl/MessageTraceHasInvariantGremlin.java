...
public class MessageTraceHasInvariantGremlin extends Feature
    ...
    public IInvariantTrace get() {
        ...
        try {
            ...
            result = (IInvariantTrace) factory.createTraceElement(to, gts);
        }
        finally {
            finishTraversal(g);
        }
    ...
    public boolean conflict(IInvariantTrace target) {
        ...
        GraphTraversalSource g = startTraversal();
        try {
            result |= delegate == null ? g.V(source.getId()).out("invariant").hasNext() : g.E(delegate).inV().hasId(target.getId()).hasNext();
    ...
    public boolean related(IInvariantTrace target) {
        ...
        GraphTraversalSource g = startTraversal();
        try {
		  result = g.E(delegate).inV().hasId(target.getId()).hasNext() && source.equals(target.message().get());
		}
		finally {
            finishTraversal(g);
        }
