 ...
 ******************************************************************************/
 /*******************************************************************************
 ** EvlContext implementation automatically generated on 2017-10-18.
 ...
 */
public abstract class AbstractEvlContextImpl<V> extends AbstractModuleElementImpl<V> {

    /**
     * Instantiates a new EvlContext implementation.
     *
     * @param delegate the delegate vertex
     */
    public AbstractEvlContextImpl(V delegate) {
        super(delegate);
    }
