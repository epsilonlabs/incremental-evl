...
public class InvariantTraceHasSatisfiesGremlin extends Feature
     ...
     */
    public InvariantTraceHasSatisfiesGremlin (IInvariantTrace source) {
        super(true);
        this.source = source;
    }
    ...
    public ISatisfiesTrace get() {
        ...
        /*
        SatisfiesTraceGremlin retVal = new SatisfiesTraceGremlin();
        retVal.delegate(to);
        retVal.graph(graph);
        */
        return (ISatisfiesTrace) TraceFactory.createModuleElementTrace(to, graph);
    }
