...
import org.eclipse.epsilon.evl.incremental.trace.IGuardResultHasContext;
import org.eclipse.epsilon.base.incremental.trace.impl.Feature;


/**
 * Implementation of IGuardResultHasContext reference. 
 */
@SuppressWarnings("unused") 
public class GuardResultHasContextGremlin extends Feature
        implements IGuardResultHasContext, TinkerpopDelegate<Edge> {
    ...
    /**
     * Instantiates a new IGuardResultHasContext.
     *
     ...
     */
    public GuardResultHasContextGremlin (
        IGuardResult source,
        Edge delegate,
   ...
   /**
    ...
    public IExecutionContext get() {
        if (delegate == null) {
            try (ActiveTraversal agts = new ActiveTraversal(gts)) {
                GraphTraversal<Vertex, Edge> et = agts.V(source.getId()).outE("context");
                if (et.hasNext()) {
                    delegate = et.next();
                }
            } catch (Exception e) {
    ...
    public boolean conflict(IExecutionContext target) {
        ...
        try (ActiveTraversal agts = new ActiveTraversal(gts)) {
            result |= delegate == null ?
                    agts.V(source.getId()).out("context").hasNext() :
    ...
    public void set(IExecutionContext target) {
        try (ActiveTraversal agts = new ActiveTraversal(gts)) {
            delegate = agts.V(source.getId()).addE("context")
