...
public class CheckTraceGremlin implements ICheckTrace, GremlinWrapper<Vertex> {
     ...
     */    
    public CheckTraceGremlin(IInvariantTrace container, Vertex vertex, Graph graph) throws TraceModelDuplicateRelation {
        this.delegate = vertex;
        this.g = new GraphTraversalSource(graph);
        this.graph = graph;
        g.V(delegate)
            .iterate();
        this.invariant = new CheckTraceHasInvariantGremlin(this);
