...
public class ArangoDBEvlUtil {
    ...
    public static Configuration getBaseConfiguration() {
        ...
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.relation", "guard:ContextTrace,InvariantTrace->GuardTrace");
        ...
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.relation", "accesses:ContextTrace,InvariantTrace,GuardTrace,MessageTrace,EvlModuleTrace,SatisfiesTrace,CheckTrace->AllInstancesAccess,ElementAccess,PropertyAccess");
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.edge", "parentTrace");
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.relation", "parentTrace:InvariantTrace,GuardTrace,MessageTrace,SatisfiesTrace,CheckTrace->ContextTrace");
        ...
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.relation", "limits:GuardTrace->ContextTrace,InvariantTrace");
        ...
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.edge", "executionTrace");
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.relation", "executionTrace:AllInstancesAccess,ElementAccess,PropertyAccess->ContextTrace,InvariantTrace,GuardTrace,MessageTrace,SatisfiesTrace,CheckTrace");
        ...
        conf.addProperty(ArangoDBGraph.ARANGODB_CONFIG_PREFIX + ".graph.relation", "moduleElements:EvlModuleTrace->ContextTrace,InvariantTrace,GuardTrace,MessageTrace,SatisfiesTrace,CheckTrace");
