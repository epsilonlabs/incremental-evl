...
public class ElementAccessHasElementGremlin extends Feature
        implements IElementAccessHasElement, TinkerpopDelegate<Edge> {
   ...
   /**
    ...
    public IModelElementTrace get() {
        if (delegate == null) {
            try (ActiveTraversal agts = new ActiveTraversal(gts)) {
                GraphTraversal<Vertex, Edge> et = agts.V(source.getId()).outE("element");
                if (et.hasNext()) {
                    delegate = et.next();
                }
            } catch (Exception e) {
    ...
    public boolean conflict(IModelElementTrace target) {
        ...
        try (ActiveTraversal agts = new ActiveTraversal(gts)) {
            result |= delegate == null ?
                    agts.V(source.getId()).out("element").hasNext() :
    ...
    public void set(IModelElementTrace target) {
        try (ActiveTraversal agts = new ActiveTraversal(gts)) {
            delegate = agts.V(source.getId()).addE("element")
