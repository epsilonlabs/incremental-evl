...
public class AllInstancesAccessHasTypeGremlin extends Feature
     ...
     */
    public AllInstancesAccessHasTypeGremlin (IAllInstancesAccess source, GraphTraversalSource gts) {
        super(true);
        this.source = source;
        this.gts = gts;
    }
    ...
    public IModelTypeTrace get() {
        ...
        try {
            ...
            result = (IModelTypeTrace) BaseTraceFactory.getFactory().createModuleElementTrace(to, gts);
        }
        finally {
            finishTraversal(g);
        }
