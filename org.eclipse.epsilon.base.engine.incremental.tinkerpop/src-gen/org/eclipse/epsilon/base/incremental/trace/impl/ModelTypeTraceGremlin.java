...
public class ModelTypeTraceGremlin implements IModelTypeTrace, GremlinWrapper<Vertex> {
     ...
     */    
    public ModelTypeTraceGremlin(String name, IModelTrace container, Vertex vertex, Graph graph) throws TraceModelDuplicateRelation {
        ...
        g.V(delegate)
            .property("name", name)
            .iterate();
        this.modelTrace = new ModelTypeTraceHasModelTraceGremlin(this);
