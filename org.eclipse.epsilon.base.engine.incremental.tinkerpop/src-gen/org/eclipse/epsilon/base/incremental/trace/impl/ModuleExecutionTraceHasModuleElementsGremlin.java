...
public class ModuleExecutionTraceHasModuleElementsGremlin extends Feature
    ...
    public Iterator<IModuleElementTrace> get() {
        return new GremlinUtils.IncrementalFactoryIterator<IModuleElementTrace, Vertex>(getRaw(),
                gts, factory);
    }
    ...
    public boolean conflict(IModuleElementTrace target) {
        ...
        try {
	        if (isUnique()) {
	           GraphTraversal<Vertex, Vertex> gt =  g.V(source.getId()).out("moduleElements");
