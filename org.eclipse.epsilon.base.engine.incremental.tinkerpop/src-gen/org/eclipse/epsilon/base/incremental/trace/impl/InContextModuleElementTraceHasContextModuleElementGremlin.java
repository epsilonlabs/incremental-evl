...
public class InContextModuleElementTraceHasContextModuleElementGremlin extends Feature
        implements IInContextModuleElementTraceHasContextModuleElement, TinkerpopDelegate<Edge> {
    ...
    public IContextModuleElementTrace get() {
        if (delegate == null) {
            try (ActiveTraversal agts = new ActiveTraversal(gts)) {
                GraphTraversal<Vertex, Edge> et = agts.V(source.getId()).outE("contextModuleElement");
                if (et.hasNext()) {
                    delegate = et.next();
                }
            } catch (Exception e) {
