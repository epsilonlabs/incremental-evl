...
public class InContextModuleElementTraceHasParentTraceGremlin extends Feature
     ...
     */
    public InContextModuleElementTraceHasParentTraceGremlin (IInContextModuleElementTrace source, GraphTraversalSource gts) {
        super(true);
        this.source = source;
        this.gts = gts;
    }
    ...
    public IContextModuleElementTrace get() {
        ...
        try {
            ...
            result = (IContextModuleElementTrace) TraceFactory.createModuleElementTrace(to, gts);
        }
        finally {
            finishTraversal(g);
        }
    ...
    public boolean conflict(IContextModuleElementTrace target) {
        ...
        GraphTraversalSource g = startTraversal();
        try {
            result |= delegate == null ? g.V(source.getId()).out("parentTrace").hasNext() : g.E(delegate).outV().hasId(target.getId()).hasNext();
        }
        finally {
            finishTraversal(g);
        }
    ...
    public void set(IContextModuleElementTrace target) {
        GraphTraversalSource g = startTraversal();
        try {
            delegate = g.V(source.getId()).addE("parentTrace").to(g.V(target.getId())).next();
        } catch (Exception ex) {
            throw ex;
        } finally {
            finishTraversal(g);
