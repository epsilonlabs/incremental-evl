...
public class ExecutionTraceManagerExtension {
	...
	public IExecutionTrace getOrCreateTraceManager() throws CoreException {
		return (IExecutionTrace) configurationElement.createExecutableExtension(TRACE_MANAGER_CLASS);
	}
