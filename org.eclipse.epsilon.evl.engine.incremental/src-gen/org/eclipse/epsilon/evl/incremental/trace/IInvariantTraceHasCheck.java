...
public interface IInvariantTraceHasCheck {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(ICheckTrace)}).
     * If the reference has an opposite, that relation is also created.
     *
     * @see ExecutionHasAccesses#conflict(ICheckTrace)
     * @see ExecutionHasAccesses#related(ICheckTrace)
     * @param target The ICheckTrace to create a relation with
     * @throws TraceModelConflictRelation if a relation to another ICheckTrace exists
     */
    boolean create(ICheckTrace target) throws TraceModelConflictRelation;
     ...
     * @see ExecutionHasAccesses#related(ICheckTrace)
     */    
    boolean destroy(ICheckTrace target);
     ...
     *  </li>
     */
    boolean conflict(ICheckTrace target);
    
    /**
     * Returns true if the target is already related via this reference.
     */
    boolean related(ICheckTrace target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(ICheckTrace)
     */
    void set(ICheckTrace target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(ICheckTrace)
     */
    void remove(ICheckTrace target);
}