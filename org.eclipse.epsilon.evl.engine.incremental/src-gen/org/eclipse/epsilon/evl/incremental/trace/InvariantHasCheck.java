...
public interface InvariantHasCheck {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(Check)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(Check)
     * @see ExecutionHasAccesses#related(Check)
     */
    boolean create(Check target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(Check)
     */
    void set(Check target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(Check)
     */
    void remove(Check target);
}