...
/**
 * Implementation of guards reference. 
 */
public class GuardHasGuardsImpl extends Feature implements GuardHasGuards {
    
    protected Guard source;
    protected GuardedElement target;
    
    /**
     * Instantiates a new GuardHasGuards.
     *
     * @param source the source of the reference
     */
    public GuardHasGuardsImpl (Guard source) {
        super(true);
        this.source = source;
    }
