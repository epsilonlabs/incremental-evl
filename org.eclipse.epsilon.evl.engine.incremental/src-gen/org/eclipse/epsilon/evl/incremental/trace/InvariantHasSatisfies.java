...
public interface InvariantHasSatisfies {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(Satisfies)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(Satisfies)
     * @see ExecutionHasAccesses#related(Satisfies)
     */
    boolean create(Satisfies target);
     ...
     * @see ExecutionHasAccesses#related(Satisfies)
     */    
    boolean destroy(Satisfies target);
     ...
     *  </li>
     */
    boolean conflict(Satisfies target);
    
    /**
     * Returns true if the target is already related via this reference.
     */
    boolean related(Satisfies target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(Satisfies)
     */
    void set(Satisfies target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(Satisfies)
     */
    void remove(Satisfies target);
}