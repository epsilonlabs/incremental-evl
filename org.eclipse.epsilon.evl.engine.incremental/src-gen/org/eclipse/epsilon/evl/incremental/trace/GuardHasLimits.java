...
public interface GuardHasLimits {
     ...
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(GuardedElement)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(GuardedElement)
     * @see ExecutionHasAccesses#related(GuardedElement)
     */
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(GuardedElement)
     */
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(GuardedElement)
     */
