...
public interface ContextHasContext {
     ...
     */
    Queue<ModelElement> get();

    /**
     * Create a reference to the target element. Returns true if the relation was created or if the
     * relation already existed. 
     * The relation is created if there are no conflicts (see {@link ExecutionHasAccesses#conflict(ModelElement)}).
     * If the reference has an opposite, that relation is also craeted.
     *
     * @see ExecutionHasAccesses#conflict(ModelElement)
     * @see ExecutionHasAccesses#related(ModelElement)
     */
    boolean create(ModelElement target);
     ...
     * @see ExecutionHasAccesses#related(ModelElement)
     */    
    boolean destroy(ModelElement target);
     ...
     *  </li>
     */
    boolean conflict(ModelElement target);
    
    /**
     * Returns true if the target is already related via this reference.
     */
    boolean related(ModelElement target);
     ...
     * relation.
     *
     * @see ExecutionHasAccesses#create(ModelElement)
     */
    void set(ModelElement target);

    /**
     * Remove a value for the reference. This method should be only accessed by classes in the
     * relation.
     *
     * @see ExecutionHasAccesses#destroy(ModelElement)
     */
    void remove(ModelElement target);
}