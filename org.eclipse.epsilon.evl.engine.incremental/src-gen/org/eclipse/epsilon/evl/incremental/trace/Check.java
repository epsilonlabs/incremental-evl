...
/**
 * The Check defines the access methods for the EClass features.
 * Additionally, the Check extends Execution acts as the root entity of the AGGREGATE of its
 * container references. That is, elements contained in the Check must be
 * created through this interface.
 */
public interface Check extends Execution {

    /** The invariant reference. */
    CheckHasInvariant invariant();
                
 
    /**
     * Check has same identity in the aggregate.
     */
