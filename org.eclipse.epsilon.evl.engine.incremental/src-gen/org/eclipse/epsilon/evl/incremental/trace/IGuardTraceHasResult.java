...
public interface IGuardTraceHasResult {
     ...
     * @param target The IGuardResult to create a relation with
     * @throws TraceModelConflictRelation if a relation to another IGuardResult exists
     */
